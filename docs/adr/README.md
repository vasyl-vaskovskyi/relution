...
| [0007](0007-part-3-direction-resilience-caching.md) | Part 3 direction: resilience + caching | Accepted; scope amended by ADR-0017, ADR-0027, ADR-0030 (retry only on connection failures), ADR-0031, ADR-0035 and ADR-0045 (outbound limiter back in scope) |
...
| [0017](0017-add-an-angular-web-client-time-boxed.md) | Add an Angular web client, time-boxed | Accepted; amended by ADR-0027, ADR-0031 (429 short-circuit) and ADR-0045 (outbound limiter is core again) |
